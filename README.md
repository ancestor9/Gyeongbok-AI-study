...
| 5주차(5.12 ~ 5.16)           | pdf 파일 로드 테스트완료, Senior 개발자 자문(5.14, 오후 7~), 맞춤형 AI 로직 설계, TF 미팅(5.15)                      | Pilot test sponsered by Frukan (5.23)                   | 개발 및 배포 환경 검토중(Vultr, Ligttning ai, 연세 GPU Server), 업체와 협업 진행 검토 중        |
